<div class="app-title">
  <ul class="app-breadcrumb breadcrumb side">
    <li class="breadcrumb-item active"><a href="#"><b>Danh Sách Hoá Đơn Đã Xác Nhận</b></a></li>
  </ul>
  <div id="clock"></div>
</div>
<div class="row">
    ...
    <div class="tile">
      <div class="tile-body">
        <div class="row element-button">
          <div class="col-sm-2">
            <a class="btn btn-delete btn-sm print-file " type="button" href="index.php?page_layout=quanlyHD"><i class="fas fa-fa-arrow-right-form-bracket"></i>
              Quay Lại </a>
          </div>
        </div>
        <table class="table table-hover table-bordered" id="sampleTable">
          ...
          <tbody>
            <?php
            include '../config.php';
            $sql = "SELECT * FROM tblhoadon WHERE trangThaiHD=1";
            ...
            while ($row = $result->fetch_assoc()) { ?>
              <tr>
                ...
                <td>
                  <?php if ($row['trangThaiHD'] == 1) {
                    echo '<span class="badge bg-success">Xác Nhận</span>';
                  }
                  ?>
                </td>
