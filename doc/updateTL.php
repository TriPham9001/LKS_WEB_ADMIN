...
include '../config.php';
$id = $_GET['id'];
$sql_up = "SELECT * FROM tbltheloai WHERE id=$id";
...
if (isset($_POST['sbm'])) {
    $id = $_POST['id']; 
    $tenTL = $_POST['tenTL'];;
    $sql = "UPDATE  tbltheloai SET tenTheLoai = '$tenTL' WHERE id='$id'";
            ...
            <div class="tile-body">
                ...
                <form class="row" method="POST">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="text" name="tenTL" required value="<?php echo $row_up['tenTheLoai'] ?>">
                    </div>
