...
$id = $_GET['id'];
$sql_up = "SELECT * FROM tblvoucher WHERE id=$id";
...
if (isset($_POST['add'])) {
    ...
    $sql = "UPDATE  tblvoucher SET idSanPham = '$idSP',tenVoucher ='$tenVoucher',discount = '$dicounts',dates = '$date' WHERE id='$id'";
            ...
            <div class="tile-body">
                ...
                <form class="row" method="POST">
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" type="text" name="id" readonly value="<?php echo $row_up['id'] ?>">
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" type="text" name="tenVoucher" require value="<?php echo $row_up['tenVoucher'] ?>">
                    </div>
                    <div class="form-group col-md-3">
                        <label class="control-label">Discount</label>
                        <input class="form-control" type="text" name="dicounts" require value="<?php echo $row_up['discount'] ?>">
                    </div>
                    <div class="form-group col-md-3">
                        <label class="control-label">Tiền thưởng</label>
                        <input class="form-control" type="date" name="date" require value="<?php echo $row_up['dates'] ?>">
                    </div>
